'use client'
import { Projeto } from "@/app/sections/projetos/index";
...
export default function ProjectDetail() {
    ...
    const pathname = usePathname(); // hook chamado no topo
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                            <div className="flex flex-wrap items-center gap-4 mb-4">
                                <span className="px-3 py-1 rounded-full bg-primary/20 border border-primary/30 text-primary text-sm font-medium backdrop-blur-md">
                                    {project?.concluido === true ? "Concluído" : "Em Andamento"}
                                </span>
                            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                >
                    <div className="space-y-4">
                        ...
                        <p className="text-lg text-muted-foreground leading-relaxed whitespace-pre-line" dangerouslySetInnerHTML={{ __html: project?.about as string }} />
